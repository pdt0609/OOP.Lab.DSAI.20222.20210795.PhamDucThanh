...
public class second_degree_equation_one_variable {
	public static void main(String [] args) {
		...
		if (a==0) {
			if (b==0) {
				...
				System.out.println("the only root of the quation is "+ (-c/b));
			}
		}else {if(denta==0) {
			System.out.println("the quation has 1 double roots:"+ (-b/2/a));
		}else if( denta>0) {
			System.out.println("the quation has 2 roots x1, x2 \nthe root x1 is:"+ ((-b+Math.sqrt(denta))/(2*a)));
